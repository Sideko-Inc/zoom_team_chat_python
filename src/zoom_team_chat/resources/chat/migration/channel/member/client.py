...
from zoom_team_chat.types.chat.migration.channel.member import params
import typing
    ...
    def migrate(
        ...
        *,
        data: typing.Optional[
            params.PostChatMigrationChannelsChannelIdMembersBody
        ] = None,
        channel_id: str,
        ...
        **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `MEDIUM`
        ...
        _json = to_encodable(
            item=data,
            dump_with=params._SerializerPostChatMigrationChannelsChannelIdMembersBody,
        )
        ...
        return self._client_wrapper.request(
            method="POST",
            path=f"/chat/migration/channels/{channel_id}/members",
